  ...
  return (
    <footer className="footer" style={{
      ...
      <div style={{
        ...
        <p>
          Developed by <a href="http://globeforge.great-site.net" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--color-primary)', fontWeight: '600', textDecoration: 'underline' }}>GlobeForge</a>
        </p>
      </div>
    </footer>
  );
