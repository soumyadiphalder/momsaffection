...
if ($wantsHtml) {
    ...
    // Check if the current host is localhost/local development
        ...
        <div class="container">
            ...
            <div class="status-grid">
                ...
                <div class="status-card">
                    ...
                    <span class="status-value">
                        <span class="port-badge <?= ($currentPort === '8000' || !$isLocalhost) ? 'correct' : '' ?>"><?= htmlspecialchars($currentPort) ?></span>
                    </span>
                </div>
            </div>

            <?php if ($isLocalhost && $currentPort !== '8000'): ?>
